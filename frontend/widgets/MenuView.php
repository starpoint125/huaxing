...
class MenuView extends \yii\base\Widget
{
    ...
    public $liTemplate = "<li id='menu-item-{menu_id}'><a href='{url}' target='{target}'><em>{title}</em></a>{sub_menu}</li>";

    public $subTemplate = "<ul >{lis}</ul>";//class=\"sub-menu\" style=\"padding-top: 20px;\"
